from utils_DDPG import Actor, Q_Critic
...
class DDPG_agent():
	...
	def save(self,timestep):
		torch.save(self.actor.state_dict(), "./ddpg_model/20240612/DDPG_actor{}.pth".format(timestep))
		torch.save(self.q_critic.state_dict(), "./ddpg_model/20240612/DDPG_q_critic{}.pth".format(timestep))

	def load(self, timestep):
		self.actor.load_state_dict(torch.load("./ddpg_model/20240612/DDPG_actor{}.pth".format(timestep), map_location=self.dvc))
		self.q_critic.load_state_dict(torch.load("./ddpg_model/20240612/DDPG_q_critic{}.pth".format(timestep), map_location=self.dvc))
