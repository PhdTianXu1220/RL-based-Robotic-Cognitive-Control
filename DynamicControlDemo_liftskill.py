...
for i in range(raise_step_num):
    print(i)
    joint_angle1 = robot1._calculateIK(np.array(tra1[0])+[0.0,0.0,-0.055]+np.array([0.0,0.0,0.005*i]), ori1[0])
    robot1._resetJointStateforce(joint_angle1)
    pb.stepSimulation()
...
for i in range(stop_step_num):
    print(i)
    joint_angle1 = robot1._calculateIK(np.array(tra1[0])+[0.0,0.0,-0.055]+np.array([0.0,0.0,+0.005*(raise_step_num-1)]), ori1[0])
    robot1._resetJointStateforce(joint_angle1)
    pb.stepSimulation()
...
for i in range(raise_step_num):
    print(i)
    joint_angle1 = robot1._calculateIK(np.array(tra1[0])+[0.0,0.0,-0.055+0.005*(raise_step_num-1)]+np.array([0.0,0.-0,-0.005*i]), ori1[0])
    robot1._resetJointStateforce(joint_angle1)
    pb.stepSimulation()
