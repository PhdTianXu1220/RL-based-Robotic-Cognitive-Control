...
def plot_multiple_arrays(*arrays):
    ...
    for index, array in enumerate(arrays):
        ...
        plt.plot(array, label=label_name,linewidth=2,color=color, linestyle=linestyle)
...
plot_multiple_arrays(mass_list_range,full_model_estimate,reduce_model_estimate)