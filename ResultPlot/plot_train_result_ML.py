...
steps_ppo, rewards_ppo = load_data('MLP energy20250323-190205.json')
...
# Plot
plt.plot(steps_ppo_smooth, rewards_ppo_smooth,linewidth=3.5,color="blue")
...
plt.xlabel('Step')
plt.ylabel('MSE Loss')
plt.title('Power Training Curve')
# plt.legend()
...
plt.savefig('ML Power Training Result.png', dpi=600, format='png')
plt.show()