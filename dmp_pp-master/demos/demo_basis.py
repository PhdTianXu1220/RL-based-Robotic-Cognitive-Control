...
fig2 = plt.figure(1)
ax = plt.subplot(111)
ax.loglog(range_nbfs, err_gaus, 'x--', lw = lwidth, markersize = ms)
ax.loglog(range_nbfs, err_t_g, '*--', lw = lwidth, markersize = ms)
ax.loglog(range_nbfs, err_t_gaus_biased, '+--', lw = lwidth, markersize = ms)
ax.loglog(range_nbfs, err_moll, 'o--', lw = lwidth, markersize = ms)
ax.loglog(range_nbfs, err_wen_2, '<--', lw = lwidth, markersize = ms)
ax.loglog(range_nbfs, err_wen_3, '1--', lw = lwidth, markersize = ms)
ax.loglog(range_nbfs, err_wen_4, '>--', lw = lwidth, markersize = ms)
ax.loglog(range_nbfs, err_wen_5, '2--', lw = lwidth, markersize = ms)
ax.loglog(range_nbfs, err_wen_6, 'v--', lw = lwidth, markersize = ms)
ax.loglog(range_nbfs, err_wen_7, '3--', lw = lwidth, markersize = ms)
ax.loglog(range_nbfs, err_wen_8, '^--', lw = lwidth, markersize = ms)
box = ax.get_position()
...
fig4 = plt.figure(2)
ax = plt.subplot(111)
ax.loglog(range_nbfs, err_gaus, 'x--', lw = lwidth, markersize = ms, label = '$\psi$')
ax.loglog(range_nbfs, err_t_g, '*--', lw = lwidth, markersize = ms, label = '$\tilde{\psi}_U$')
ax.loglog(range_nbfs_param, err_t_gaus_n_param, '+--', lw = lwidth, markersize = ms, label = '$\tilde{\psi}_B$')
ax.loglog(range_nbfs, err_moll, 'o--', lw = lwidth, markersize = ms, label = '$\varphi_i$')
ax.loglog(range_nbfs, err_wen_2, '<--', lw = lwidth, markersize = ms, label = '$\phi_i^{(2)}$')
ax.loglog(range_nbfs, err_wen_3, '1--', lw = lwidth, markersize = ms, label = '$\phi_i^{(3)}$')
ax.loglog(range_nbfs, err_wen_4, '>--', lw = lwidth, markersize = ms, label = '$\phi_i^{(4)}$')
ax.loglog(range_nbfs, err_wen_5, '2--', lw = lwidth, markersize = ms, label = '$\phi_i^{(5)}$')
ax.loglog(range_nbfs, err_wen_6, 'v--', lw = lwidth, markersize = ms, label = '$\phi_i^{(6)}$')
ax.loglog(range_nbfs, err_wen_7, '3--', lw = lwidth, markersize = ms, label = '$\phi_i^{(7)}$')
ax.loglog(range_nbfs, err_wen_8, '^--', lw = lwidth, markersize = ms, label = '$\phi_i^{(8)}$')
box = ax.get_position()
ax.set_position([box.x0, box.y0, box.width * 0.85, box.height])
ax.legend(loc = 'center left', bbox_to_anchor=(1,0.5), fontsize = fs)
