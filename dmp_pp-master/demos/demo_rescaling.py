...
plt.plot(new_goal_rot[0], new_goal_rot[1], '*k', markersize = ms, label = 'New goal position')
...
plt.plot(new_goal_dilat[0], new_goal_dilat[1], '*k', markersize = ms, label = 'New goal position')
plt.plot(0, 0, '.k', markersize=ms)
plt.xlabel(' x_1 ', fontsize=14)
plt.ylabel(' x_2 ', fontsize=14)
plt.axis('equal')
...
plt.plot(new_goal_shrink[0], new_goal_shrink[1], '*k', markersize = ms, label = 'New goal position')
plt.plot(0, 0, '.k', markersize=ms)
plt.xlabel(' x_1 ', fontsize=14)
plt.ylabel(' x_2 ', fontsize=14)
plt.axis('equal')
...
plt.plot(goal_track[-1][0], goal_track[-1][1], '*k', markersize = ms, label = 'New goal position')
plt.plot(0, 0, '.k', markersize=ms)
plt.xlabel('x_1 ', fontsize=14)
plt.ylabel(' x_2 ', fontsize=14)
plt.axis('equal')
